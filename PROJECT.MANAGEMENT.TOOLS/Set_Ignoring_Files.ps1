...
Add-Content -Path $TARGET_PATH -Value '*.txt'

Add-Content -Path $TARGET_PATH -Value 'Compiler_Output'

Add-Content -Path $TARGET_PATH -Value 'Compiler_Output_For_Binary_Files'

Add-Content -Path $TARGET_PATH -Value 'Output_For_File_Updater'
