 ...
 int main(int argc, char** argv){
     ...
     Header_Builder.Receive_Data_Type(Data_Type_Name);

     Header_Builder.Receive_Entered_Class_Name(Entered_Class_Name);

     Header_Builder.Receive_Construction_Point(Construction_Point_Pointer);

     Header_Builder.Receive_Data_Type_Include_File_Name(Data_Type_Header_File_Pointer);
