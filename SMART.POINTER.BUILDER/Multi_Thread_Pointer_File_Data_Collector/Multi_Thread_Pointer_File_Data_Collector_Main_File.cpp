 ...
 int main(int argc, char** argv){
     ...
     std::cout << "\n Header File Name List :"
               ...
               << File_Data_Collector.Get_Header_File_Name_List() << "#";

     std::cout << "\n Source File Name List :"

               << File_Data_Collector.Get_Source_File_Name_List() << "#";
     ...
     std::cout << "\n\n Compiler_Command_For_ReportFileBuilder:"

               << File_Data_Collector.Get_Compiler_Command_For_ReportFileBuilder() << "#";

     std::cout << "\n\n Compiler_Command_For_Memory_Manager:"

               << File_Data_Collector.Get_Compiler_Command_For_MemoryManager() << "#";

     std::cout << "\n\n Compiler_Command_For_Smart_Pointer:"

               << File_Data_Collector.Get_Compiler_Command_For_SmartPointer() << "#";

     std::cout << "\n\n Object_File_List:"

               << File_Data_Collector.Get_Object_File_List();

     std::cout << "\n\n New_Class_Name:"

               << File_Data_Collector.Get_New_Class_Name() << "#";
