 ...
 int main(int argc, char** argv){
     ...
     ReportFileBuilder_HeaderWriter HeaderWriter;
     ...
     HeaderWriter.Receive_Data_Type(Data_Type_Name);

     HeaderWriter.Receive_Construction_Point(Construction_Point_Pointer);

     HeaderWriter.Receive_Entered_Class_Name(Entered_Class_Name_Pointer);

     HeaderWriter.Build_Header_File();
