...
void Determine_Test_Command(char ** test_command, char * exe_file, char * frame_number, char * input_file);
...
int main(int argc, char ** argv){
    ...
    if(argc != 5) {
       ...
       << " [Repitation] [Test program] [Frame Number] [Input File]"
                            ...
                            char * frame_number,char * input_file)
{
     ...
     int command_lenght = input_file_string_length + exe_file_string_lenght +
