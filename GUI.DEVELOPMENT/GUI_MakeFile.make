...
include PATHS_FOR_GUI_MAKE_FILES

VPATH = $(ID) $(OD) $(LD) $(INC) $(LNC) $(GUI_PATH) $(MAINFRAME_PATH)

Pcynlitx.exe : wxLauncher.cpp MainFrame.o Process_Execution_Controller.o keyboard_event_controler.o \
	...
	g++ -std=c++11 $(CONFIGS) $(INCLUDE_DIRECTORIES) $(LIBRARY_DIRECTORIES) \
 	       wxLauncher.cpp $(OD)\MainFrame.o $(OD)\Process_Execution_Controller.o $(OD)\keyboard_event_controler.o \
				 ...
				 $(OD)\Project_Folder_Lister.o $(OD)\Style_Loader.o $(OD)\ClassSyntaxControl.o $(OD)\ClassNameReader.o \
				 $(OD)\Intro_Page_Loader.o $(OD)\Help_Page_Loader.o $(OD)\Custom_TextCtrl.o $(OD)\Custom_Window.o  \
				 $(OD)\Custom_wxPanel.o $(OD)\Custom_wxTreeCtrl.o \
	       ...
	       -include Custom_TabArt.h -include Custom_TextCtrl.h -include Custom_DockArt.h  \
			   ...
			   -include Event_ID_Numbers.h -include Custom_wxTreeCtrl.h -include wxDirTraverser_executer.h \
				  $(LINKING_LIBRARIES) -o Pcynlitx.exe
